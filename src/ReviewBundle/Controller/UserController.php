...
class UserController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $users = $em->getRepository('ReviewBundle:User')->findAll();
    ...
    {
        $user = new User();
        $form = $this->createForm('ReviewBundle\Form\UserType', $user);
    ...
    {
        $deleteForm = $this->createDeleteForm($user);
        $editForm = $this->createForm('ReviewBundle\Form\UserType', $user);
